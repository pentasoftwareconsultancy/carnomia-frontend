...
export default function AboutUs() {
  return (
    <>
      ...
      <section className="flex flex-col md:flex-row items-center justify-center gap-10 max-md:px-4 bg-primary py-16">
        {/* Image Section */}
        <div className="relative shadow-2xl shadow-button rounded-2xl overflow-hidden shrink-0">
          <img
          ...
          <div className="flex items-center gap-1 max-w-72 absolute bottom-8 left-8 bg-white p-4 rounded-xl">
            <div className="flex -space-x-4 shrink-0">
              ...
              />
              <div className="flex items-center justify-center text-xs text-white size-9 rounded-full border-[3px] border-white bg-button hover:-translate-y-1 transition z-[4]">
                50+
              </div>
            </div>
        ...
        <div className="text-sm text-slate-600 max-w-lg px-2">
          ...
          <Link to="/about-us">
          <button className="flex items-center gap-2 mt-8 hover:-translate-y-0.5 transition bg-button py-3 px-8 rounded-full text-white">
            <span>Read more</span>
            <svg
              width="13"
              height="12"
