      ...
      <div className="grid md:grid-cols-[60%_40%] gap-10">
        ...
        <div>
          ...
          >
            ...
            <p className="text-gray-700">
              That's why a Pre-Delivery Inspection (PDI) from Drivesta is a smart,
        ...
        >
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-3xl font-bold text-green-700">Trending Blogs</h2>
          </div>
          {/* Trending blog boxes */}
          <div className="space-y-5">
            {[
              ...
              { title: "What You Get With Drivesta", date: "Aug 23, 2023", link: "#final-thoughts" },
    ...
    {section.list && (
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div>
            <p className="font-semibold text-base mb-1 text-lg">
          ...
          <a
            href="/contact"
            className="bg-green-400 hover:bg-green-500 text-black font-semibold text-lg px-5 py-2 rounded"
          >
            Contact Us
          </a>
        </div>
