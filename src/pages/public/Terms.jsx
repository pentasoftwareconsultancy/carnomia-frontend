...
<h1 className="text-green-400 text-3xl md:text-4xl font-heading mt-2">Terms and Conditions</h1>
...
>
<h2 className="text-base md:text-lg font-body text-gray-800 mb-2">{title}</h2>
