...
<h1 className="text-green-400 text-3xl md:text-4xl font-bold mt-2">Terms and Conditions</h1>
<p className="text-gray-300 text-sm mt-2">Welcome to Drivesta.com.</p>
</motion.header>
{/* Main Content */}
  <div className="flex justify-center py-10 px-4">
    <div className="bg-white border-4 border-white max-w-5xl w-full rounded-xl shadow-md p-6 md:p-10 space-y-6 text-sm md:text-base">
      ...
      >
        By accessing or using our website and services, you agree to the terms outlined below. Please read them carefully.
      </motion.p>
...
className="border border-gray-300 rounded-md p-5 shadow-sm bg-white"
>
<h2 className="text-base md:text-lg font-semibold text-gray-800 mb-2">{title}</h2>
...
content:
"Drivesta offers Pre-Delivery Inspection (PDI) services for new and used cars across selected cities in India. Our services include on-site inspections, digital reports, and consultation before a vehicle is purchased.",
},
{
title: "Booking and Scheduling",
list: [
"Users must provide accurate information about the vehicle, seller location, and preferred inspection time.",
"Drivesta reserves the right to reschedule or cancel a booking due to unforeseen circumstances (e.g., weather, unavailability, etc.).",
...
list: [
"Drivesta inspections are visual and tool-based checks. We do not dismantle or open parts of the vehicle.",
...
"Drivesta is not responsible for any delays or incomplete checks due to denied access.",
...
list: [
"Drivesta is not liable for any loss, damage, or costs incurred as a result of using our inspection service or relying solely on the report.",
...
content:
"All materials, including reports, logos, text, and visual media, provided by Drivesta are protected by copyright and may not be reused or redistributed without written permission.",
},
{
