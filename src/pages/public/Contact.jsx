...
>
  <h1 className="text-white text-4xl font-bold drop-shadow-lg">CONTACT US</h1>
</div>
      {/* Top Info Section */}
  ...
  <div className="text-gray-800 w-full md:w-1/2 max-w-xl">
    ...
    <div className="mb-6">
      <h4 className="font-semibold text-lg border-b pb-2">LOCATION</h4>
      <p className="mt-2 text-s text-gray-600">Pune, Maharashtra</p>
    </div>
    <div className="mb-6">
      <h4 className="font-semibold text-lg border-b pb-2">EMAIL & PHONE</h4>
      <p className="mt-2 text-s text-gray-600">support@drivesta.com</p>
      <p className="text-s text-gray-600">(+91) 7385978109 / 7378554409</p>
    </div>
    <div className="mb-6">
      <h4 className="font-semibold text-lg border-b pb-2">WEBSITE</h4>
      <p className="mt-2 text-s text-gray-600">www.drivesta.com</p>
    </div>
    <div className="mb-6">
      <h4 className="font-semibold text-lg border-b pb-2">CUSTOMER SUPPORT HOURS</h4>
      <p className="mt-2 text-s text-gray-600">
        Monday to Sunday: 09:30 AM – 06:30 PM
      </p>
    </div>
    <div>
      <h4 className="font-semibold text-lg border-b pb-2">FOLLOW US</h4>
