...
const ProfilePhotos = () => {
  const labels = ['frontLeft', 'frontRight', 'rearLeft', 'rearRight'];
  ...
  const labelNames = {
    ...
    frontRight: '2. Rear Left',
    rearLeft: '3. Rear Right',
    rearRight: '4. Front Right',
  };
  ...
  const handleFileUpload = (e, label) => {
    ...
    if (file && file.type.startsWith('image/')) {
      ...
      reader.onloadend = () => {
        setPhotos((prev) => ({ ...prev, [label]: reader.result }));
  ...
  return (
    <div className="bg-[#ffffff0a] backdrop-blur-[16px] border border-white/10 rounded-2xl p-6 sm:p-8 shadow-[0_4px_30px_rgba(0,0,0,0.2)] w-full max-w-4xl mx-auto text-white">
      <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-white text-left">Profile Photos</h2>
