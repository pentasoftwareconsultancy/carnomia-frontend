          ...
          <div className="mt-2 flex flex-col">
            ...
            <div className="mt-2 flex items-center relative">
              ...
              <video
                ref={(el) => (videoRefs.current.vinNumber = el)}
                autoPlay
                playsInline // ✅ prevents fullscreen camera on mobile
                muted // ✅ avoids autoplay restrictions on mobile
                className={
                  isCameraActive.vinNumber
                    ? "w-24 h-24 rounded-md ml-2"
                    : "hidden"
                }
              />
            </div>
